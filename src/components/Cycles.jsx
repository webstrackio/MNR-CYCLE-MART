      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center px-6 sm:px-10 lg:px-14 py-16 lg:py-20 max-w-2xl w-full">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-5 leading-tight">
            Ride Beyond Limits with{' '}
            <span className="text-gradient">Premium Cycles</span>
          </h2>

          <p className="text-white/80 text-base sm:text-lg mb-9 max-w-xl leading-relaxed">
            At M N R Cycle Mart, we offer quality cycles from top brands, expert guidance for
            every rider, and a wide range of models to suit every journey. Find the perfect ride
            today.
          </p>
          ...
          <div className="flex items-center gap-6 mb-9">
            <div className="flex flex-col">
              ...
              <span className="text-white/70 text-xs sm:text-sm uppercase tracking-wider">Years of Trust</span>
            </div>
            <div className="w-px h-10 bg-white/20" />
            <div className="flex flex-col">
              <span className="text-2xl sm:text-3xl font-bold text-accent">100+</span>
              <span className="text-white/70 text-xs sm:text-sm uppercase tracking-wider">Cycle Models</span>
            </div>
          </div>
