    ...
    <footer className="bg-primary border-t border-white/5">
      <div className="section-padding py-16 lg:py-20">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 bg-secondary rounded-lg flex items-center justify-center
                           text-cream/40 hover:text-brand hover:bg-brand/10 transition-all duration-300"
              >
            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-cream/40 text-sm hover:text-brand transition-colors duration-200
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  ...
                  className="text-cream/40 text-sm hover:text-brand transition-colors duration-200
                             inline-flex items-center gap-2"
                >
                  <svg className="w-4 h-4 text-brand/60" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                ...
                >
                  ...
                  hello@mnrcyclemart.com
                </a>
              </li>
              <li>
                <span className="text-cream/40 text-sm inline-flex items-start gap-2">
                  <MapPin className="w-4 h-4 text-brand/60 flex-shrink-0 mt-0.5" />
          ...
          {/* Business Hours */}
          <div>
            <h4 className="text-cream font-semibold mb-4">Business Hours</h4>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-cream/50">Monday — Saturday</span>
                <span className="text-cream font-medium">9:30 AM – 8:00 PM</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-cream/50">Sunday</span>
                <span className="text-cream font-medium">10:00 AM – 6:00 PM</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-cream/30 text-sm">
            &copy; {new Date().getFullYear()} M N R Cycle Mart. All rights reserved.
          </p>
          <p className="text-cream/30 text-sm">
