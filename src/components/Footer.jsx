        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 bg-surface rounded-lg flex items-center justify-center
                           text-muted hover:text-accent hover:bg-accent/10 transition-all duration-300"
              >
              ...
              <a
                href="https://www.instagram.com/mnr.cyclex?igsi=MWIyaWRiMmR2aXFwcw=="
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-surface rounded-lg flex items-center justify-center
                           text-muted hover:text-accent hover:bg-accent/10 transition-all duration-300"
            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <Link
                    to={link.href}
                    className="relative group text-muted text-sm hover:text-accent transition-colors duration-200
                               inline-flex items-center gap-1 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-accent after:transition-all after:duration-300 hover:after:w-full"
                  >
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                href="https://wa.me/918919267847"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-muted text-sm hover:text-accent transition-colors duration-200
                             inline-flex items-center gap-2"
                >
                  <svg className="w-4 h-4 text-accent/60" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                ...
                >
                  ...
                  mnrcyclemartchittoor@gmail.com
                </a>
              </li>
              <li>
                <span className="text-muted text-sm inline-flex items-start gap-2">
                  <MapPin className="w-4 h-4 text-accent/60 flex-shrink-0 mt-0.5" />
                  # 17-328, 17-329, TV Naidu Street
                </span>
              </li>
            </ul>
          </div>
