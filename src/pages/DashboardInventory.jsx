...
import { Warehouse, Search, Package, AlertTriangle, CheckCircle, XCircle } from 'lucide-react';
...
export default function DashboardInventory() {
  ...
  return (
    <AdminLayout title="Inventory" subtitle="Track stock levels and inventory" icon={Warehouse}>
