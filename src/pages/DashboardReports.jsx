...
import { BarChart2, TrendingUp, TrendingDown, DollarSign, ShoppingCart, Users, Package } from 'lucide-react';
...
export default function DashboardReports() {
  return (
    <AdminLayout title="Reports" subtitle="Sales and performance reports" icon={BarChart2}>
