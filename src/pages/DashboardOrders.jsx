...
import { ShoppingCart, Search, Eye, ChevronDown, Package, Truck, CheckCircle, XCircle } from 'lucide-react';
...
export default function DashboardOrders() {
  ...
  return (
    <AdminLayout title="Orders" subtitle="Manage and track customer orders" icon={ShoppingCart}>
